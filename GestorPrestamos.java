...
public class GestorPrestamos {
    ...
    public void registrarPrestamoDiseno() {
        ...
        int cantidadAsignaturas = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la cantidad de asignaturas inscritas:"));
        ...
        float tamano = Float.parseFloat(JOptionPane.showInputDialog("Ingrese el tamaño de la tableta gráfica en pulgadas:"));
    ...
    public void modificarPrestamoDiseno() {
        ...
        if (estudiante != null) {
            String nuevoTelefono = JOptionPane.showInputDialog("Ingrese el nuevo teléfono:");
            String nuevaModalidad = JOptionPane.showInputDialog("Ingrese la nueva modalidad de estudio (Virtual/Presencial):");
            int nuevasAsignaturas = Integer.parseInt(JOptionPane.showInputDialog("Ingrese la nueva cantidad de asignaturas:"));
